...
class S {
  ...
  String get enterPhoneLinkedToCourt => _t(
  ...
  String get invalidJordanianNumber =>
      _t('Enter a valid Jordanian mobile number.', 'أدخل رقم هاتف أردني صحيح.');
  String get phoneNotLinked => _t(
    'This number is not linked to any court account.',
  ...
  String resendCodeIn(int seconds) =>
      _ar ? 'إعادة الإرسال خلال $seconds ث' : 'Resend in ${seconds}s';
  String get sending => _t('Sending...', 'جارٍ الإرسال...');
  String get pleaseEnterCode =>
      _t('Please enter the code.', 'يرجى إدخال الرمز.');
  String get invalidCode => _t(
    'Invalid code. Please try again.',
    'رمز غير صحيح. يرجى المحاولة مجدداً.',
  );
  String get resendFailed => _t(
    'Failed to resend. Please go back and try again.',
  ...
  String get monthlyRevenueJod =>
      _t('Monthly Revenue (JOD)', 'الإيرادات الشهرية (د.أ)');
  ...
  String get invoiceDownloaded =>
      _t('Invoice downloaded.', 'تم تنزيل الفاتورة.');
  ...
  String removeFromBlacklist(String phone) =>
      _ar
          ? 'إزالة $phone من القائمة السوداء؟'
  ...
  String saveFailed(String e) => _ar ? 'فشل الحفظ: $e' : 'Save failed: $e';

  // Settings validation
  String get courtNameEmpty =>
      _t('Court name cannot be empty.', 'لا يمكن أن يكون اسم الملعب فارغاً.');
  String get closingBeforeOpening => _t(
    'Closing time must be after opening time.',
    'يجب أن يكون وقت الإغلاق بعد وقت الفتح.',
  );
  String get selectOneWorkingDay => _t(
    'Select at least one working day.',
    'اختر يوماً عملياً واحداً على الأقل.',
  );
  ...
  String get tapDateToMarkVacation => _t(
  ...
  String get confirmDeleteBody => _t(
  ...
  String get reservationUpdated => _t('Reservation updated', 'تم تحديث الحجز');
  String get fieldTakenError => _t(
    'That field was just booked for this time. Pick another field.',
    'تم حجز هذا الملعب لهذا الوقت للتو. اختر ملعباً آخر.',
  );
  ...
  String noShowWarning(String phone) =>
      _ar
  ...
  String noShowDialogBody(String name, String phone) =>
      _ar
  ...
  String noShowRecorded(String phone) =>
      _ar
  ...
  String get selectDayAndSize => _t(
    'Select a day and size to view available slots',
  ...
  String confirmDurationLabel(int n) =>
      _ar
  ...
  String get slotFullError => _t(
    'This slot is no longer available. Please choose another time.',
    'هذا الوقت لم يعد متاحاً. يرجى اختيار وقت آخر.',
  );
  String bookingErrorGeneric(String err) =>
      _ar ? 'تعذر إتمام الحجز ($err).' : 'Could not complete booking ($err).';
  ...
  String get vacationDayWarning => _t(
  ...
  String tournamentSubtitle(String date, String time, int count) =>
      _ar
  ...
  String get maxUses => _t(
    'Max Uses (leave blank = unlimited)',
    'الحد الأقصى للاستخدام (اتركه فارغاً = غير محدود)',
  );
  ...
  String get confirmDeletePromo =>
      _t('Delete this promo code?', 'حذف رمز الخصم هذا؟');
  ...
  String promoDiscount(String type, double val) =>
      type == 'percent'
          ? _t(
            '${val.toStringAsFixed(0)}% off',
            'خصم ${val.toStringAsFixed(0)}%',
          )
          : _t(
            '${val.toStringAsFixed(2)} JOD off',
            'خصم ${val.toStringAsFixed(2)} د.أ',
          );
  String promoUsage(int uses, int? max) =>
      max == null
  ...
  String get searchCustomers =>
      _t('Search by name or phone…', 'ابحث باسم أو هاتف…');
  String get noCustomers => _t('No customers yet.', 'لا يوجد عملاء بعد.');
  String get noMatchingCustomers =>
      _t('No customers match your search.', 'لا يوجد عملاء مطابقون.');
  ...
  String get noPricingRules => _t(
    'No pricing rules. Tap + to add one.',
    'لا توجد قواعد تسعير. اضغط + للإضافة.',
  );
  String get ruleLabel => _t('Rule Name', 'اسم القاعدة');
  String get ruleLabelHint =>
      _t('e.g. Weekend Rate', 'مثال: سعر نهاية الأسبوع');
  String get ruleType => _t('Rule Type', 'نوع القاعدة');
  String get recurringDays =>
      _t('Recurring (specific days)', 'متكرر (أيام محددة)');
  String get oneOffDate =>
      _t('One-off (specific date)', 'مرة واحدة (تاريخ محدد)');
  ...
  String get ruleCreated =>
      _t('Pricing rule created.', 'تم إنشاء قاعدة التسعير.');
  ...
  String get staffInviteSent => _t(
    'Invite sent. They can now log in with this number.',
  ...
  String get confirmRemoveStaff => _t(
    'Remove this staff member? They will lose access immediately.',
    'إزالة هذا الموظف؟ سيفقد الوصول فوراً.',
  );
  String get confirmRevokeInvite => _t(
    'Revoke this invite? The person will no longer be able to log in.',
    'إلغاء هذه الدعوة؟ لن يتمكن الشخص من تسجيل الدخول بعد الآن.',
  );
  String get staffPhoneHint => _t('07X XXX XXXX', '07X XXX XXXX');
  String get staffAccessNote => _t(
    'Staff can view reservations, customers & tournaments — but not financials, pricing or promo codes.',
  ...
  String get noRecurring => _t(
    'No recurring reservations. Tap + to add one.',
  ...
  String get recurringCreated => _t(
    'Recurring reservation created and scheduled.',
    'تم إنشاء الحجز المتكرر وجدولته.',
  );
  String get recurringDeleted =>
      _t('Recurring reservation deleted.', 'تم حذف الحجز المتكرر.');
  String recurringScheduled(int n) =>
      _ar
          ? 'تم جدولة $n حجز قادم'
          : '$n upcoming booking${n == 1 ? '' : 's'} scheduled';
  String recurringSubtitle(String day, String time, String size, String name) =>
      _ar
          ? '$day الساعة $time · $size · $name'
          : '$day at $time · $size · $name';
}
